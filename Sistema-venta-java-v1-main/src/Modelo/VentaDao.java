...
public class VentaDao {
    ...
    public List Listarventas(){
       ...
       String sql = "SELECT r.ID_del_cliente AS id_cli, r.Nombre_completo AS Nombre_cli, v.* FROM reservas r INNER JOIN ventas v ON r.ID_del_cliente = v.cliente";
       try {
           con = cn.getConnection();
           ps = con.prepareStatement(sql);
           rs = ps.executeQuery();
    ...
    public void pdfV(int idventa, int Cliente, double total, String usuario) {
        try {
            ...
            PdfPCell cliNom = new PdfPCell(new Phrase("Nombre_completo", negrita));
            PdfPCell cliTel = new PdfPCell(new Phrase("Dirección", negrita));
            PdfPCell cliDir = new PdfPCell(new Phrase("Número_de_teléfono", negrita));
            ...
            String prove = "SELECT * FROM reservas WHERE ID_del_client= ?";
            try {
